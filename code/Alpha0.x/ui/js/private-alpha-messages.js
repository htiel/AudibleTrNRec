const PRIVATE_ERROR_LABELS = Object.freeze({
  ...
  'export-consent-misconfigured': 'The export could not ask for your confirmation, so nothing was exported and no file was created.',
  'export-consent-missing': 'The export was not confirmed, so nothing was requested and no file was created.',
  'export-document-invalid': 'The local ATnR runtime did not return a complete export document. No file was written.',
