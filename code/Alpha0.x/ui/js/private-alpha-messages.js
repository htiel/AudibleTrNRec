const PRIVATE_ERROR_LABELS = Object.freeze({
  ...
  'local-api-bootstrap-unauthenticated': 'The local ATnR runtime refused an unauthenticated bootstrap. The private session stopped safely.',
  'local-api-capability-invalid': 'The unlock code was not accepted by the local ATnR runtime.',
  'local-api-confirmation-cancelled': 'The confirmation unlock was cancelled. Nothing changed.',
  ...
  'local-api-session-invalid': 'The local ATnR session ended. This happens after connecting, disconnecting or erasing local data, and when a session expires. Reload and unlock again.',
  'local-api-unlock-cancelled': 'The local ATnR unlock was cancelled. No library data was loaded.',
